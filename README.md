...
# I'm not maintaining this library anymore. The community is continuing development of Spine at [jsonapi-ios/Spine](https://github.com/jsonapi-ios/Spine). Feel free to use that fork, and submit pull-requests or open issues there.
